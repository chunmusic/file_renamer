...
from qfluentwidgets import setTheme, Theme, FluentWindow, MessageBox, FluentIcon, NavigationItemPosition, PrimaryPushButton, LineEdit
...
class FileRenamerApp(FluentWindow):
    def __init__(self):
        ...
        self.addSubInterface(self.main_widget, FluentIcon.DOCUMENT, "Rename Files", position=NavigationItemPosition.TOP)

        # Theme setup
        setTheme(Theme.AUTO)
        # Comment out mica effect to avoid qframelesswindow dependency
